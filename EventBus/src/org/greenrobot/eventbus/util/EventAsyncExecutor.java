 ...
 * @author Markus
 */
public class EventAsyncExecutor {
    ...
    public static class Builder {
        ...
        public EventAsyncExecutor build() {
            return buildForScope(null);
        }

        public EventAsyncExecutor buildForScope(Object executionContext) {
            if (eventBus == null) {
            ...
            return new EventAsyncExecutor(threadPool, eventBus, failureEventType, executionContext);
        }
    }
    ...
    public static EventAsyncExecutor create() {
    ...
    private EventAsyncExecutor(Executor threadPool, EventBus eventBus, Class<?> failureEventType, Object scope) {
        this.threadPool = threadPool;
        this.eventBus = eventBus;
        this.scope = scope;
        try {
